...
DDclipped_cost <- resample(cost_unclip, pixel_default, filename="repro_cost", overwrite=T)
...
The difference raster (`diff`; "cost_diff.grd") is the other main output of the workflow and is more relevant for the discussion to follow. This raster is a comparison of the 
